...
//  合约地址
const UNIVERSAL_POINTS_ADDRESS = "0xf6aE8083f1A0Bf5B7993A57f5CeD85fDBa9BB17e";//通用积分地址
const POINTS_EXCHANGE_ADDRESS  = "0x80ABCf7168789961Af8D03EF71c6f3d68b55baCE";//积分兑换地址
  ...
  return (
    <div className="App">
      ...
      <nav className="navbar">
        <ul>
          <li><a href="#home">基于区块链的积分通兑平台</a></li>
        </ul>
      </nav>
        ...
        {!isWalletConnected ? (
          ...
          <div>
            ...
            <section id="deploy">
              ...
              />
              <button onClick={handleDeploy}>部署积分合约</button>
            </section>
  
            <div className="import-issue-container">
          <section id="load">
            <h3>导入普通积分合约</h3>
            <input
              type="text"
          ...
          <section id="issue">
            ...
            <section id="exchange">
              ...
              <button onClick={exchangePoints}>进行兑换</button>
            </section>
          </div>
        )}
      </div>
